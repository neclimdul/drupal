...
/**
 * @file
 * Contains \Drupal\Core\Command\DbImportApplication.
 */
 ...
 */
class DbImportApplication extends Application {
  ...
  protected function getDefaultCommands() {
    ...
    $default_commands[] = new DbImportCommand($this->connection, $this->moduleHandler);
